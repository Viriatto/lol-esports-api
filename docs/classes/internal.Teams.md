[LoL Esports API Wrapper - v0.2.2](../README.md) / [Exports](../modules.md) / [internal](../modules/internal.md) / Teams
...
[src/interfaces/teams.ts:23](https://github.com/Viriatto/lol-esports-api/blob/eef32c6/src/interfaces/teams.ts#L23)
