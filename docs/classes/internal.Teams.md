[LoL Esports API Wrapper - v0.3.0](../README.md) / [Exports](../modules.md) / [internal](../modules/internal.md) / Teams
...
[src/interfaces/teams.ts:23](https://github.com/Viriatto/lol-esports-api/blob/ffa02fa/src/interfaces/teams.ts#L23)
