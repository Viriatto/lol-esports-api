[LoL Esports API Wrapper - v0.2.5](../README.md) / [Exports](../modules.md) / [internal](../modules/internal.md) / Events
...
[src/interfaces/events.ts:29](https://github.com/Viriatto/lol-esports-api/blob/d78a7bd/src/interfaces/events.ts#L29)
