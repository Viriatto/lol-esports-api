[LoL Esports API Wrapper - v0.2.2](../README.md) / [Exports](../modules.md) / [internal](../modules/internal.md) / Events
...
[src/interfaces/events.ts:29](https://github.com/Viriatto/lol-esports-api/blob/eef32c6/src/interfaces/events.ts#L29)
